...
import SeconderyCard from "./UI/SeconderyCard";
import useViewHealthInsuranceSecondery from "./hooks/useViewHealthInsuranceSecondery";
const ViewHealthInsuranceSecondery = () => {
  const { formData, certificateRef, loading, genderOptions, handleOpenPDF } =
    useViewHealthInsuranceSecondery();
  ...
  return (
    <div className="space-y-6">
        ...
        <form className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            ...
            <InputWithIcon
              disabled
              value={
                formData?.expiryCerDate != "" ? formData.expiryCerDate : null
              }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            <InputWithIcon
              disabled
              value={
                formData?.issueCerDate != "" ? formData.issueCerDate : null
              }
      ...
      {formData && (
        ...
        >
          <SeconderyCard ref={certificateRef} data={formData} />
        </div>
      )}
    </div>
  );
