...
// const handleOpenPDF = async () => {
//     // the div is zooming in the pdf i wanna it to be rendered in the pdf as it is as its real width and height
...
//       const height = pdf.internal.pageSize.getHeight() - 50;
