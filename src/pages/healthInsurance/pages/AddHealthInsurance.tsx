...
import useAddHealthInsurance from "../hooks/useAddHealthInsurance";
        ...
        <form onSubmit={handleSubmit} className=" flex flex-col gap-5">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            <InputWithIcon
              ...
              onChange={(e: any) =>
                handleFieldChange("certificateNumber", e?.target?.value)
              }
            ...
            <InputWithIcon
              ...
              icon={<GrCertificate size={20} />}
              onChange={(e: any) =>
                handleFieldChange("amana", e?.target?.value)
              }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            <InputWithIcon
              ...
              icon={<GrCertificate size={20} />}
              onChange={(e: any) =>
                handleFieldChange("programType", e?.target?.value)
              }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            <InputWithIcon
              ...
              isRequired
              error={errors?.programExpiry}
              onChange={(e: any) =>
                handleFieldChange("programExpiry", e.target.value)
              }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            <InputWithIcon
              icon={<MdDateRange size={20} />}
              isRequired
              error={errors?.expiryCerDateHijri}
              onChange={(e: any) =>
                handleFieldChange("expiryCerDateHijri", e.target.value)
              }
            ...
            <InputWithIcon
              icon={<MdDateRange size={20} />}
              isRequired
              error={errors?.issueCerDate}
              onChange={(e: any) =>
                handleFieldChange("issueCerDate", e.target.value)
              }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-[24px] justify-center items-center">
            <InputWithIcon
              icon={<MdDateRange size={20} />}
              isRequired
              error={errors?.issueCerDateHijri}
              onChange={(e: any) =>
                handleFieldChange("issueCerDateHijri", e.target.value)
              }
            ...
            <InputWithIcon
              icon={<MdDateRange size={20} />}
              isRequired
              error={errors?.expiryCerDate}
              onChange={(e: any) =>
                handleFieldChange("expiryCerDate", e.target.value)
              }
